...
class RunActionRunTest(ActionRunTest):
    def __init__(
        self,
        action_name: str,
        inventory: List[str] = [],
        playbook: List[str] = [],
        playbook_artifact: Optional[str] = None,
        *args,
        **kwargs,
    ) -> None:
        ...
        self._playbook_artifact = playbook_artifact
        self._app_args["inventory"] = self._inventory
        self._app_args["playbook"] = self._playbook
        self._app_args["playbook_artifact"] = self._playbook_artifact
